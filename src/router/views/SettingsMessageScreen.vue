  ...
  <v-container>
    ...
    <v-form>
      <v-row>
        <v-col sm="3">
          <h3>Class</h3>
          <v-select dense v-model="choosenClass" :items="allClasses" menu-props="auto" outlined> </v-select>
        </v-col>
        <v-col sm="3">
          <h3>Range date</h3>
      ...
      <v-btn style="margin-top: -2%" @click="exportPDFAnnouncement" color="primary">Export</v-btn>
    </v-form>
    ...
    <v-form>
      <v-row>
        <v-col sm="3">
          <h3>Class</h3>
          <v-select dense v-model="choosenClass" :items="allClasses" menu-props="auto" outlined> </v-select>
          <v-btn style="margin-top: -1%" @click="exportPDFParticipant" color="primary"> Export </v-btn>
        </v-col>
      </v-row>
    </v-form>
    <v-divider class="dividerCSS"></v-divider>
